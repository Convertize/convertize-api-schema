...
freight_schema = modules.new_propertie(name="schema", type="object", properties=freight_componente, required=["id", "title"])
...
export = {
    ...
    "Frete": modules.ConvertizeLink(
        ...
        fields=[
            coreapi.Field(name='environment', required=True, location='path', description=u"Ambinete do cliente", schema={"type": "string"}),
            coreapi.Field(name='freight_id', required=True, location='path', description=u"ID do frete", schema={"type": "integer"}),
