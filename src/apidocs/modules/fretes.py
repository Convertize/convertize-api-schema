...
freight_componente = dict([
    modules.new_propertie(name="id", type="integer", nullable=False,
                          format="int64", description=u"ID do frete"),
    modules.new_propertie(name="zipcode", type="integer",
                          nullable=False, description=u"Código postal"),
    modules.new_propertie(name="amount", type="float", nullable=False,
                          description=u"Quantidade de itens no carrinho"),
    modules.new_propertie(name="items", type="array",
                          nullable=False, description=u"Itens"),
    modules.new_propertie(name="weight", type="float",
                          nullable=False, description=u"Peso"),
    modules.new_propertie(name="ean_13", type="integer",
                          nullable=False, description=u"Código de barras"),
    modules.new_propertie(name="height", type="float",
                          nullable=False, description=u"Altura"),
    modules.new_propertie(name="width", type="float",
                          nullable=False, description=u"Largura"),
    modules.new_propertie(name="reference_code", type="integer",
                          nullable=False, description=u"Código de referência SKU"),
    modules.new_propertie(name="depth", type="float",
                          nullable=False, description=u"Profundidade"),
    modules.new_propertie(name="quantity", type="integer",
                          nullable=False, description=u"Quantidade")
])
